...
class App extends React.Component {
  ...
  componentDidMount() {
    const apiKey = "AIzaSyAk0svS0tjBgrZ4ywig4RY9wd3rrhGBaig";
    const initSpreadsheetId = "1sCgmzBIq2K9jUckLuYSWbDq4CuNUfdtuE6a5xI3I5Hw";
    const initUrl = `https://sheets.googleapis.com/v4/spreadsheets/${initSpreadsheetId}/values:batchGet?ranges=Sheet1&majorDimension=ROWS&key=${apiKey}`;
    this.populateDashboard(initUrl);
  }
        ...
        <Nav className="navbar navbar-expand-lg fixed-top is-infront is-dark">
          ...
          <Container className="navbar-nav ml-auto">
            <Container className="user-detail-section">
              <button className="upload-btn" onClick={this.clickUpload}>
                UPLOAD YOUR SHEET
              </button>
            </Container>
          </Container>
        ...
        <Nav
          className={
            this.state.isUploadMode
              ? "hide navbar fixed-top nav-secondary is-dark is-light-text"
